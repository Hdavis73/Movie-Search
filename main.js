...
let searchTitle = document.querySelector('.search-bar').innerText
const videoPlayer = document.querySelector('.top-main')
const contentArray = Array.from(track.children)
const contentImg = []
const searchBtn = document.querySelector('.search')
const partnerData = `https://api.themoviedb.org/3/search/movie?api_key=70220a5ffde49b1cd73aad90c1741b08&query=all`

window.onresize = function(){location.reload}


fetch('https://api.themoviedb.org/3/movie/popular?api_key=70220a5ffde49b1cd73aad90c1741b08&language=en-US&page=1')
    ...
    .then(data => {
        ...
        for (let i = 0; i <= data.results.length - 1; i++) {
            ...
            // const partnerLogoLg = document.querySelector('.partner-logo-lg')
            ...
            // createLogo.src = data[i].partnerLogoURL
            div.classList.add('video-img')
            img.classList.add('video-img')
            // createLogo.classList.add('partner-logo')
